...
func (x *DiscountReply) GetDiscount() string {
	if x != nil {
		return x.Discount
	}
	return ""
...
var file_discount_proto_rawDesc = []byte{
	...
	0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x49, 0x0a, 0x0f, 0x44, 0x69, 0x73, 0x63, 0x6f,
	...
	,
...
var file_discount_proto_goTypes = []interface{}{
	(*DiscountRequest)(nil), // 0: proto.DiscountRequest
	(*DiscountReply)(nil),   // 1: proto.DiscountReply
}
var file_discount_proto_depIdxs = []int32{
	0, // 0: proto.Discount.GetDiscount:input_type -> proto.DiscountRequest
	1, // 1: proto.Discount.GetDiscount:output_type -> proto.DiscountReply
...
func (c *discountClient) GetDiscount(ctx context.Context, in *DiscountRequest, opts ...grpc.CallOption) (*DiscountReply, error) {
	out := new(DiscountReply)
	err := c.cc.Invoke(ctx, "/proto.Discount/GetDiscount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedDiscountServer) GetDiscount(context.Context, *DiscountRequest) (*DiscountReply, error) {
...
func _Discount_GetDiscount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Discount/GetDiscount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DiscountServer).GetDiscount(ctx, req.(*DiscountRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Discount_serviceDesc = grpc.ServiceDesc{
	ServiceName: "proto.Discount",
